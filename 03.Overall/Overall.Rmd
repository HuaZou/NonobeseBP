...
PCoA$circle
ggsave("../datset/pdf/Fig3A.pdf", PCoA$circle, width = 6, height = 5, dpi = 300)
...
ggsave("../datset/pdf/Fig3A12.pdf", width = 4, height = 2, dpi = 300)
```
...
cowplot::plot_grid(beta.ge, beta.sp,
  ncol = 2, align = "h", axis = "b",
  labels = c("B", "C"))
ggsave("../datset/pdf/F3BC.pdf", width = 4, height = 2.5, dpi = 300)
```
...
cowplot::plot_grid(index.ge, index.sp,
  ncol = 2, align = "h", axis = "b",
  labels = c("D", "E"))
ggsave("../datset/pdf/F3DE.pdf", width = 4, height = 2.5, dpi = 300)
```
